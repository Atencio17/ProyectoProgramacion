    ...
    <div class="row">
        <aside>
            <div class="divaside ">
                ...
                <a href="administradorcategorias.php"><button type="button " class="botones ">Definir categorias</button></a><br>
                <a href="administradormateriasprimas.php"><button type="button " class="botones ">Definir materias primas o reactivos</button></a><br>
                <a href="administradorevolucion.php"><button type="button " class="botones ">Definir evolución</button></a><br>
            </div>
        </aside>

        <section>
            <h4 style="text-align: center; ">PAGINA PRINCIPAL ADMINISTRADOR</h4>
            <table>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td style="width: 70%; ">
                        <p>Desde aquí podrá definir categorias y definir materias primas o reactivos que se utilizarán en los servicios.</p>
